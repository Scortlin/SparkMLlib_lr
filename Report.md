...
### 5.2 Бизнес-вывод
GBT ОПРАВДАН — прирост точности >10% при увеличении времени обучения в 1.5 раза является более чем приемлемым для batch-обучения 
и может принести компании миллионы долларов дополнительной выручки за счет улучшения удержания пользователей (retention) и персонализации.
